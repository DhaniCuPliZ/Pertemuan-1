                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        @can('manage-product')
                            <a href="{{ route('product.create') }}"
                               class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold rounded-lg transition duration-150 shadow-sm">
